...
#
# MODIFIED FROM map2pseudo.sh SEE NOTEBOOK, PAGE 98 (19.05.2020)
...
do
	...
	INFILE1="$CLONE$INMAIN$CLONE"_"$SAMPLENO.mapped.R1.fq.gz"
	INFILE2="$CLONE$INMAIN$CLONE"_"$SAMPLENO.mapped.R2.fq.gz"
	...
	OUTREPORT="contaminants/$ASSEMBLY.false_positives.report.csv"
